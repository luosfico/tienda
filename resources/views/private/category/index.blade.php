            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <a href="{{ route('category.create') }}">
                        <div class="info-box">
                            <span class="info-box-icon bg-success elevation-1"><i class="fas fa-sort"></i></span>
                            <div class="info-box-content">
                                <span class="info-box-text text-bold text-dark">Registrar Nueva</span>
                                <span class="info-box-text text-bold text-dark">Categoria</span>
                            </div>
                        </div>
                    </a>
                </div>
                                        ...
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-info btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    <a class="dropdown-item" href="{{route('category.edit', $item->id)}}">Actualizar</a>
